...
#getting information from users when they login and verifying it with the database
#also handling any errors
...
#logging users out by setting the session to None and handling any errors
...
#Storing addess information in the database when users add an address and handling any errors
...
#Storing order in the orders database when users place an order and handling any errors
...
#Creating a help ticket with the users email when they submit for help and handliing any errors
...
#seaching the database and diplaying results when users seach for an order and hadling any errors
...
#seaching databse and displaying results when users seach for a customer and handling any errors
