...
#json structure of users with names, emails, numbers and passwords
user_json = [
	{
		"name": "John Doe",
...
#json structure for products with names, images, ratings and price
product_json = [
	{
...
#updating the user and product database with the json structures
def seeder():
